  ...
  Widget build(BuildContext context) {
    return Scaffold(
                ...
                child: Container(
                  ...
                  child: Stack(children: [
                    Container(
                      width: double.infinity,
                      height: double.infinity,
                      child: Image.asset('assets/valo.png', fit: BoxFit.cover),
                    ),
                    Align(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: ClipRRect(
                      ...
                      child: SizedBox.fromSize(
                        size: Size.fromRadius(40),
                        child: Image.asset('assets/OP.jfif', fit: BoxFit.cover),
                      ),
                    ),
                  ),
                ],
      ...
      floatingActionButton: FloatingActionButton.extended(
        onPressed: () {
          Navigator.pushNamed(context, Buyweapons.routeName);
        },
        label: Text("Buy"),
        icon: Icon(Icons.shopping_cart),
        backgroundColor: Color.fromARGB(255, 131, 29, 22),
      ),
    );
  }
}
